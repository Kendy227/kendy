...
def get_product_server_list(product_id):
    # API endpoint for retrieving product server list
    api_url = f"https://moogold.com/wp-json/v1/api/product/server_list/{product_id}"  # Replace with the actual API endpoint
...
get_product_server_list(product_id)